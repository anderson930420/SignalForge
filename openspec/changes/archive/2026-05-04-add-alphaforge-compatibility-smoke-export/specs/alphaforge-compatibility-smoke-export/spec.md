# AlphaForge Compatibility Smoke Export Package

## Purpose

Define a deterministic compatibility smoke package that demonstrates SignalForge can emit AlphaForge-consumable artifacts without importing AlphaForge internals.
